...
-define(RESPONDERS, [{fax_route_req, [{<<"dialplan">>, <<"route_req">>}]}
                     ,{fax_route_win, [{<<"dialplan">>, <<"route_win">>}]}
                    ]).
-define(QUEUE_NAME, <<>>).
...
%%--------------------------------------------------------------------
start_link() ->
    gen_server:start_link(?MODULE, [{bindings, ?BINDINGS}
